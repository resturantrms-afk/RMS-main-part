...
<<<<<<< HEAD
    return BlocBuilder<OrderBloc, OrderState>(
      builder: (context, state) {
        ...
        final pending =
            orders.where((e) => e.status == OrderStatus.pending).length;

        final preparing =
            orders.where((e) => e.status == OrderStatus.preparing).length;

        final ready =
            orders.where((e) => e.status == OrderStatus.ready).length;
