...
class Cart extends StatelessWidget {
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        const Spacer(),
                        // Profile avatar (reuse from CashierTopBar style)
  ...
  void _completeOrder({
    ...
    // 1. Get the logged-in user's info to store in createdBy
    ...
    final order = OrderModel(
      ...
      totalPrice: total,
      status: OrderStatus.pending, // Kitchen gets it as "pending"
      createdAt: Timestamp.now(),
      items: cartState.items,
    );

    // 3. Fire AddOrder to Firestore
